...
.EQU vector_low, 29h
.EQU vector_high, 2bh
.EQU warmboot_magic1, 31h		; x				31h
.EQU warmboot_magic2, 32h		; x				32h
...
int0_table:
        ...
        .db int0_none_handler - int0_table
        .db int0_dac_silence - int0_table
        .db int0_dma_dac_adpcm2 - int0_table
        .db int0_dma_dac_adpcm2_6 - int0_table
        .db int0_dma_dac_adpcm4 - int0_table
        .db int0_op5_handler - int0_table
        .db int0_none_handler - int0_table
        .db int0_none_handler - int0_table
        .db int0_none_handler - int0_table
        .db int0_none_handler - int0_table
...
X0edc:
		...
		movx	@r0,a
X0efa:
		jb		command_byte_1,dma_dac1_adpcm_use_2bit
		setb	23h.0
		mov		rb1r2,#4
		lcall	X1317
		clr		2fh.0
...
; ------------------------------
; 94h: Command D6: Continue 16-bit DMA mode
; ------------------------------
cmd_dma16_resume:
		lcall	X0af1
		clr		2fh.1
